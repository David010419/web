...
// ── Plantilla: notificación interna para Dani ─────────────────────────────────
        ...
        <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;">
          ...
          <tr>
            <td style="background:linear-gradient(135deg,#1a0a00 0%,#2d1200 50%,#1a0a00 100%);border-radius:12px 12px 0 0;padding:40px 40px 30px;text-align:center;border-bottom:3px solid #C9A84C;">
              ...
              <h1 style="margin:0;font-size:28px;font-weight:900;color:#ffffff;letter-spacing:-0.5px;">Nuevo mensaje recibido</h1>
          ...
          <tr>
            <td style="background:#141414;padding:40px;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:28px;">
                ...
                <tr>
                  <td style="padding:1px 0;background:#0d0d0d;"></td>
                </tr>
                <tr>
          ...
          <tr>
            <td style="background:#0a0a0a;border-radius:0 0 12px 12px;padding:24px 40px;text-align:center;border-top:1px solid #222;">
              <p style="margin:0 0 6px;font-size:12px;color:#555;">Este email fue generado automáticamente desde el formulario de contacto de</p>
              <p style="margin:0;font-size:12px;color:#777;">
                <a href="https://danimirallesoficial.com" style="color:#C9A84C;text-decoration:none;">danimirallesoficial.com</a>
              </p>
            </td>
          </tr>
...
// ── Plantilla: confirmación al usuario que escribe ────────────────────────────
        ...
        <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;">
          ...
          <tr>
            <td style="background:#141414;padding:48px 40px 36px;">
              ...
              <p style="margin:0 0 16px;font-size:15px;line-height:1.8;color:#cccccc;">
                He recibido tu mensaje y me alegra que hayas dado el paso. En cuanto pueda me pondré en contacto contigo personalmente.
              </p>

              <p style="margin:0 0 32px;font-size:15px;line-height:1.8;color:#cccccc;">
                Mientras tanto, si tienes alguna urgencia no dudes en escribirme directamente o llamarme.
              </p>
          ...
          <tr>
            <td style="background:#0a0a0a;border-radius:0 0 12px 12px;padding:24px 40px;text-align:center;border-top:1px solid #222;">
              <p style="margin:0 0 4px;font-size:12px;color:#555;">Este email fue generado automáticamente. Por favor no respondas a este correo.</p>
