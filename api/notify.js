      ...
      <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;">
        ...
        <tr>
          <td style="background:#141414;padding:48px 40px 36px;text-align:center;">
            ...
            <h2 style="margin:0 0 16px;font-size:24px;font-weight:900;color:#ffffff;">¡Estás dentro!</h2>
            <p style="margin:0 0 20px;font-size:15px;line-height:1.8;color:#cccccc;max-width:440px;margin-left:auto;margin-right:auto;">Te he apuntado a la lista de espera. Serás de los primeros en recibir el enlace cuando el álbum esté disponible.</p>
            <p style="margin:0 0 36px;font-size:14px;color:#888;">No SPAM. Solo música.</p>
